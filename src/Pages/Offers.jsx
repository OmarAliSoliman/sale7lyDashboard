...
export default class Offers extends Component {
  ...
  componentDidMount() {
    // console.log("hi");
    axios
      .get("http://sal7lyy-001-site1.gtempurl.com/api/Offer/GetAllOffers")
      .then((res) => {
        if (res.status === 200) {
          this.setState({
            lodintable: false,
  ...
  deleteOffer = async (dat) => {
    ...
    try{
      await axios.delete("http://sal7lyy-001-site1.gtempurl.com/api/Offer/DeleteOffer/" + dat.id).then((res)=>{
        if(res.status === 200){
