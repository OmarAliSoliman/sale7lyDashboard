...
class AddNewEmploee extends Component {
  state = {
    fullName: "",
    password: "",
    mobile: "",
    ...
    const submitForm = async (e) => {
      ...
      if (errors === null) {
        ...
        try {
          await axios
            .post(
              "http://sal7lyy-001-site1.gtempurl.com/api/Employee/Create",
              state
            )
            .then((res) => {
              console.log(res);
          ...
          toast.error("برجاء التاكد من المعلومات وان المستخدم لم يتم تسجيله من قبل");
          console.log(ex);
          this.setState({
            loading: false,
            disabled: false,
            ...
            <div className="cardForm">
              <form action="" onSubmit={submitForm}>
                <div className="row">
                  ...
                  <div className="col-sm-12 col-md-12 col-lg-6">
                    <div className="form-group">
                      <label htmlFor="employy-city">المدينة</label>
                      <select
                        name="cityId"
                        className="form-control"
                        id="employy-city"
