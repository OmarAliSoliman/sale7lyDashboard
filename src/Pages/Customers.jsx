...
class Customers extends Component {
  ...
  componentDidMount() {
    // console.log("hi");
    axios.get("http://sal7lyy-001-site1.gtempurl.com/api/Customer/GetAllCustomer").then((res) => {
      if (res.status === 200) {
        this.setState({
          lodintable: false,
        });
  ...
  deleteCustomer = async (dat) => {
    ...
    try {
      await axios
        .delete("http://sal7lyy-001-site1.gtempurl.com/api/Customer/Delete/" + dat.id)
        .then((res) => {
