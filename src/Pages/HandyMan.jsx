...
class HandyMan extends Component {
  ...
  componentDidMount() {
    // console.log("hi");
    axios.get("http://sal7lyy-001-site1.gtempurl.com/api/HandyMan/GetAllHandyMen  ").then((res) => {
      if (res.status === 200) {
        this.setState({
          lodintable: false,
        });
  ...
  deleteHandyMan = async (dat) => {
    ...
    try {
      await axios
        .delete("http://sal7lyy-001-site1.gtempurl.com/api/HandyMan/Delete/" + dat.id)
        .then((res) => {
